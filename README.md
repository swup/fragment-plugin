...
[![E2E Tests](https://img.shields.io/github/actions/workflow/status/swup/fragment-plugin/e2e-tests.yml?branch=master&label=e2e%tests)](https://github.com/swup/fragment-plugin/actions/workflows/e2e-tests.yml)
